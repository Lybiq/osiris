...
export const KEY_DEFS: KeyDef[] = [
  // ✈ FLIGHTS
  { env: 'OPENSKY_CLIENT_ID', label: 'OpenSky Username', hint: 'opensky-network.org — free, enables higher rate limits', registerUrl: 'https://opensky-network.org/index.php/-/login', secret: false, section: '✈ FLIGHTS' },
  { env: 'OPENSKY_CLIENT_SECRET', label: 'OpenSky Password', hint: 'opensky-network.org — same credentials as web login', registerUrl: 'https://opensky-network.org/index.php/-/login', secret: true, section: '✈ FLIGHTS' },
  ...
  // 🚢 SHIPS
  { env: 'AIS_API_KEY', label: 'AISstream.io Key', hint: 'aisstream.io — free tier available, WebSocket AIS stream', registerUrl: 'https://aisstream.io/authenticate', secret: true, section: '🚢 SHIPS' },
  ...
  // 🛰 SATELLITES
  { env: 'N2YO_API_KEY', label: 'N2YO API Key', hint: 'n2yo.com/api — free key for satellite TLE & pass predictions', registerUrl: 'https://www.n2yo.com/login/register', secret: true, section: '🛰 SATELLITES' },

  // 🌤 WEATHER
  { env: 'OPENWEATHER_KEY', label: 'OpenWeatherMap Key', hint: 'openweathermap.org — free tier: 60 calls/min', registerUrl: 'https://home.openweathermap.org/users/sign_up', secret: true, section: '🌤 WEATHER' },
  ...
  // 🔥 EVENTS
  { env: 'FIRMS_API_KEY', label: 'NASA FIRMS', hint: 'firms.modaps.eosdis.nasa.gov — active fire data', registerUrl: 'https://firms.modaps.eosdis.nasa.gov/api/area/', secret: true, section: '🔥 EVENTS' },
  ...
  // 🚌 TRANSIT
  { env: 'TRANSITLAND_KEY', label: 'Transitland API Key', hint: 'transit.land — global transit data, free tier: 100k req/month', registerUrl: 'https://www.transit.land/documentation', secret: true, section: '🚌 TRANSIT' },

  // 🗺 MAPS
  { env: 'MAPTILER_KEY', label: 'MapTiler Key', hint: 'maptiler.com — free tier: 100k tiles/month', registerUrl: 'https://cloud.maptiler.com/auth/widget?next=https://cloud.maptiler.com/account/keys/', secret: true, section: '🗺 MAPS' },
  ...
  // ✈ FLIGHTS (additional)
  { env: 'ADSBLOL_KEY', label: 'adsb.lol Key', hint: 'adsb.lol — community flight tracker, free tier available', registerUrl: 'https://adsb.lol', secret: true, section: '✈ FLIGHTS' },
  ...
  // 📡 OSINT
  { env: 'SHODAN_KEY', label: 'Shodan API Key', hint: 'shodan.io — IoT/device search engine', registerUrl: 'https://account.shodan.io/register', secret: true, section: '📡 OSINT' },
  { env: 'CENSYS_KEY', label: 'Censys API Key', hint: 'censys.io — internet-wide scan data', registerUrl: 'https://accounts.censys.io/register', secret: true, section: '📡 OSINT' },
  { env: 'VIRUSTOTAL_KEY', label: 'VirusTotal Key', hint: 'virustotal.com — malware/URL analysis', registerUrl: 'https://www.virustotal.com/gui/join-us', secret: true, section: '📡 OSINT' },

  // 🤖 AI
  { env: 'GEMINI_API_KEY_1', label: 'Gemini API Key', hint: 'aistudio.google.com/apikey — KI-Analyse', registerUrl: 'https://aistudio.google.com/apikey', secret: true, section: '🤖 AI' },
];
