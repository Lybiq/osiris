...
const SYSTEM_PROMPT = `You are OSINT Intelligence Analyst — a senior, elite intelligence analyst embedded within the OSINT Global Intelligence Platform. You operate at the level of a Palantir Forward Deployed Engineer crossed with a CIA PDB (Presidential Daily Brief) analyst.
...
You have access to the live intelligence context of the OSINT platform. Analyze it with precision.`;

const BRIEFING_PROMPT = `Generate a comprehensive OSINT Daily Intelligence Briefing based on the current operational data. Structure it as follows:
