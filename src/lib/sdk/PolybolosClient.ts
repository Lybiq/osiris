 ...
 * ║                                                                 ║
 * ║  Subscribes to OSINT feeds + external providers (Lattice),     ║
...
export class PolybolosClient {
  ...
  /** Connect to the OSINT SSE stream endpoint */
  ...
  /**
   * Ingest raw OSINT data and translate it into Polybolos entities.
  ...
  private getActiveFeedCount(): number {
    let count = 0;
    // Count OSINT feeds that have data
